...
MODEL                := sl_drivepoint
MODULES              := rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c sl_drivepoint_data.c 
MAKEFILE             := sl_drivepoint.mk
...
#
MODELLIB                  := sl_drivepointlib_rtwin.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := sl_drivepoint_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;D:/04Robet/robotics-toolbox-matlab-master/simulink/sl_drivepoint_rtwin_win64;D:/04Robet/robotics-toolbox-matlab-master/simulink;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
