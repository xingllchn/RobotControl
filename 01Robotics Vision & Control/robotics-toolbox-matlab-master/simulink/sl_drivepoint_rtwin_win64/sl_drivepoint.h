...
#define sl_drivepoint_rtModel          RT_MODEL_sl_drivepoint_T
...
typedef struct {
  ...
  real_T TmpSignalConversionAtsfunxyInport1[2];
} B_sl_drivepoint_T;
...
#define rtB                            sl_drivepoint_B
#define BlockIO                        B_sl_drivepoint_T
#define rtX                            sl_drivepoint_X
#define ContinuousStates               X_sl_drivepoint_T
#define rtXdot                         sl_drivepoint_XDot
#define StateDerivatives               XDot_sl_drivepoint_T
#define tXdis                          sl_drivepoint_XDis
#define StateDisabled                  XDis_sl_drivepoint_T
#define rtY                            sl_drivepoint_Y
#define ExternalOutputs                ExtY_sl_drivepoint_T
#define rtP                            sl_drivepoint_P
#define Parameters                     P_sl_drivepoint_T
#define rtDWork                        sl_drivepoint_DW
#define D_Work                         DW_sl_drivepoint_T
#define rtPrevZCSigState               sl_drivepoint_PrevZCX
#define PrevZCSigStates                PrevZCX_sl_drivepoint_T
...
extern void sl_drivepoint_output(void);
extern void sl_drivepoint_update(void);
